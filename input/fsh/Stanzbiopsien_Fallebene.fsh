Instance: Prostata_Stanzbiopsie_Fallebene
...
* language = #de-DE
* url = "https://art-decor.org/fhir/Questionnaire/Prostata_Stanzbiopsie_Fallebene"
...
// Primäres Gleason Muster - Epstein 2005
        * item[+]
            * insert addItem("2.16.840.1.113883.3.1937.777.18.2.38", #choice, "Primäres Gleason Muster - Epstein 2005")
            * insert observationExtract
            * insert observationExtract_laboratory_InCategory
            * insert observationExtractSectionInCategory(22635-7 "Pathology report microscopic observation")
            * code = $loinc#44641-9 "Gleason pattern.primary in Prostate tumor"
            * answerOption[0].valueCoding = $sct#369770006 "Gleason Pattern 1 (finding)"
...
// Anzahl Positive Stanzen rechts
            * item[+]
                ...
                * code[0] = $sct#399727003:18720000=251597001 "Number of tissue cores positive for carcinoma (observable entity):In (attribute)=Structure of right lateral lobe of prostate (body structure)"
                * code[+] = $sct#385356007:363698007=251597001,47429007:399727003 "Tumor stage finding (finding) - Finding site (attribute) = Structure of right lateral lobe of prostate (body structure), Associated with (attribute) = Number of tissue cores positive for carcinoma (observable entity)"
...
// Anzahl Positive Stanzen links
            * item[+]
                ...
                * code[0] = $sct#399727003:18720000=251695000 "Number of tissue cores positive for carcinoma (observable entity):In (attribute)=Structure of left lateral lobe of prostate (body structure)"
                * code[+] = $sct#385356007:363698007=251695000,47429007:399727003 "Tumor stage finding (finding) - Finding site (attribute) = Structure of left lateral lobe of prostate (body structure), Associated with (attribute) = Number of tissue cores positive for carcinoma (observable entity)"
...
// Verhältnis positiver zu allen Stanzen
            * item[+]
                ...
                * code[0] = $loinc#44651-8 "Tissue cores.positive.carcinoma in Tissue core"
...
// Tumorbefall Gesamt in Länge in mm
            * item[+]
                ...
                * code[0] = $loinc#44618-7 "Total linear mm of carcinoma"
                * extension[0].url = "http://hl7.org/fhir/StructureDefinition/questionnaire-unitOption"
...
// Lokalisation Extraprostatische Tumorausbreitung
            * item[+]
                ...
                * answerOption[0].valueCoding = $loinc#LA25151-4 "Apical"
